...
CANONICAL_SPEC_SCREENS = (
    ...
    SpecScreen("4.2", "歷史紀錄頁", "history", ("historyCalendarDisplayItems.map", "historyDailySummaryDisplayItems.map", "selectedHistoryDailySectionItems.map")),
    SpecScreen("4.3", "基本分析頁", "analysis", ("analysisRangeDisplayOptions.map", "analysisBeforeMealGlucoseDisplayCount")),
    ...
    SpecScreen("4.6.1", "帳號與登入安全頁", "accountSecurity", ("authProviderDisplayItems.map", "sessionManagementDisplayItems.map")),
    SpecScreen("4.6.2", "個人資料頁", "profileSettings", ("profileSettingsBoundaryRows.map", "profileReadinessChecklistItems")),
    ...
    SpecScreen("4.14.2", "醫師 / 醫院合作預覽頁", "doctorShare", ("doctorShareReadinessChecklistItems.map", "doctorShareActionStatus")),
    SpecScreen("4.14.3", "HealthKit / Health Connect / 血糖機預覽頁", "healthIntegration", ("healthIntegrationReadinessChecklistItems.map", "healthIntegrationActionStatus")),
    SpecScreen("4.14.4", "食物社群頁", "community", ("foodCommunityCategoryDisplayOptions.map", "foodCommunityShareFieldRows.map")),
