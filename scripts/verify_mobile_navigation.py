...
def main() -> int:
    ...
    try:
        ...
        for label, marker in (
            ...
            ("store redeemable fulfillment helper", "export function storeRedeemableFulfillmentCopy(category: StoreFutureCategory): string"),
            ...
            ("store categories static config", "export const storeCategories: Array<{ id: StoreFutureCategory; label: string }> = ["),
            ...
            ("store category display helper", "export function storeCategoryDisplayItem(value: { id: StoreFutureCategory; label: string })"),
