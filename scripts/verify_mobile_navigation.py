...
def main() -> int:
    ...
    try:
        ...
        for label, marker in (
            ...
            ("daily record parse appends transcript entry", "appendDailyTranscriptEntry(transcriptEntry);"),
            ("daily record parse transcript source binding", "parserTranscriptSource(parserVoiceSeconds)"),
