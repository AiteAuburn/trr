...
def main() -> int:
    ...
    try:
        ...
        for label, marker in (
            ...
            ("preview edit option target helper fields", "return option.value;"),
            ...
            ("record edit option target helper fields", "return option.value;"),
        ...
        for label, marker in (
            ...
            ("ranking opt-in dynamic button label", "const rankingOptInButtonDisplayLabel = communityActionDisplay.rankingOptInButton;"),
            ("ranking opt-in dynamic accessibility label", "const rankingOptInAccessibilityDisplayLabel = communityActionDisplay.rankingOptInAccessibility;"),
