...
def main() -> int:
    ...
    try:
        ...
        for label, marker in (
            ...
            ("native llama input guard binding", "if (!llamaInput.modelPath || !llamaInput.transcript)"),
            ...
            ("native llama benchmark append helper fields", "if (llamaInput.modelPath && llamaInput.transcript) {\n      results.push(await benchmarkNativeLlama(nativeLlamaRequestArgs(llamaInput)));\n    }"),
