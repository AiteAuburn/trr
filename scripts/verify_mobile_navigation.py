...
def main() -> int:
    ...
    try:
        ...
        for label, marker in (
            ...
            ("native benchmark success helper", "function handleNativeBenchmarkSuccess(results: Array<Awaited<ReturnType<typeof benchmarkNativeWhisper>> | Awaited<ReturnType<typeof benchmarkNativeLlama>>>)"),
