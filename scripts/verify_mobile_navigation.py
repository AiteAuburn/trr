...
def main() -> int:
    ...
    try:
        ...
        for label, marker in (
            ...
            ("native whisper input guard binding", "if (!whisperInput.modelPath || !whisperInput.audioPath)"),
            ...
            ("native whisper benchmark append helper fields", "if (whisperInput.modelPath && whisperInput.audioPath) {\n      results.push(await benchmarkNativeWhisper(nativeWhisperRequestArgs(whisperInput)));\n    }"),
