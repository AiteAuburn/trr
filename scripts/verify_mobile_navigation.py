...
def main() -> int:
    ...
    try:
        ...
        for label, marker in (
            ...
            ("parse request helper binding", "const response = await requestParserPreview(\n        account.id,\n        activeProfile.id,\n        transcript,\n        parseOccurredAt,\n        parserVoiceSeconds"),
            ...
            ("parse merge response helper binding", "const mergedDailyPreview = mergedParserPreviewForResponse(existingDailyPreview, response);"),
