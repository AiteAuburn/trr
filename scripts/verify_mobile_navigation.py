...
def main() -> int:
    ...
    try:
        ...
        for label, marker in (
            ...
            ("parse request helper binding", "const mergedDailyPreview = await requestPreparedParserPreview(\n        parserContext,\n        transcript,\n        preparedRequest"),
            ...
            ("parse merge response helper binding", "const mergedDailyPreview = await requestPreparedParserPreview("),
            ...
            ("parse success helper binding", "handlePreparedParserPreviewSuccess(mergedDailyPreview, transcript, preparedRequest);"),
        ...
        for label, marker in (
            ...
            ("daily record parse appends transcript entry", "handlePreparedParserPreviewSuccess(mergedDailyPreview, transcript, preparedRequest);"),
