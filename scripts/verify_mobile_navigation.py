...
def main() -> int:
    ...
    try:
        ...
        for label, marker in (
            ...
            ("parse request body helper binding", "body: JSON.stringify(\n            parserPreviewRequestBody(activeProfile.id, transcript, parseOccurredAt, parserVoiceSeconds)\n          )"),
            ("parse request voice seconds", "voice_seconds: voiceSeconds"),
            ("parse request voice seconds binding", "parserPreviewRequestBody(activeProfile.id, transcript, parseOccurredAt, parserVoiceSeconds)"),
        ...
        for label, marker in (
            ...
            ("daily record parse sends shared timestamp", "parserPreviewRequestBody(activeProfile.id, transcript, parseOccurredAt, parserVoiceSeconds)"),
