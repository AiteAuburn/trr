...
def main() -> int:
    ...
    try:
        ...
        for label, marker in (
            ...
            ("parse request helper binding", "await completePreparedParserPreviewRequest(parserContext, parserTranscriptText(), preparedRequest);"),
            ...
            ("parse transcript text helper binding", "completePreparedParserPreviewRequest(parserContext, parserTranscriptText(), preparedRequest);"),
