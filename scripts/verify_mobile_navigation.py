...
def main() -> int:
    ...
    try:
        ...
        for label, marker in (
            ...
            ("parse transcript append helper binding", "appendParserTranscriptEntry(parseOccurredAt, transcript, parserVoiceSeconds);"),
        ...
        for label, marker in (
            ...
            ("daily record parse appends transcript entry", "appendParserTranscriptEntry(parseOccurredAt, transcript, parserVoiceSeconds);"),
