...
def main() -> int:
    ...
    required_readme_markers = {
        ...
        "shareable APK release type choice": "To make a release APK that can be shared with another Android phone:",
        "internal APK preflight": "npm run preflight:android-apk:internal",
        "production APK preflight": "npm run preflight:android-apk:production",
        "tester install guidance": "adb install app-release.apk",
        "release APK no Metro guidance": "does not need `npm run start`, `npx expo start`, Metro",
