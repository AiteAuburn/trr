...
- 已存在少量獨立 module：
  ...
  - `settingsScreenData.ts`：Settings row config, tutorial steps, auth provider/session/subscription/privacy static preview rows, and bounded Settings row display item shaping.
