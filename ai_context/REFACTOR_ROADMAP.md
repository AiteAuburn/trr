...
- 已存在少量獨立 module：
  ...
  - `recordWorkflowCopy.ts`：parser / AI review / AI save-confirm / AI remove-confirm / daily-record leave guard / AI save / AI candidate bounded copy and status messages.
