...
- 已存在少量獨立 module：
  ...
  - `futureModuleDisplay.ts`：future-module bounded display card, selected-module display shaping, future-preview boundary display items, and future-preview section labels.
