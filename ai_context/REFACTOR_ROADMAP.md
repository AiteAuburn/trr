...
- 已存在少量獨立 module：
  ...
  - `futureModuleDisplay.ts`：future-module bounded display card, selected-module display shaping, food-photo and store/cart future display copy, future-preview boundary display items/copy, and future-preview section labels.
