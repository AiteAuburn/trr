...
- 已存在少量獨立 module：
  ...
  - `recordStatusCopy.ts`：record sync / update / delete-confirm / delete / manual-create bounded copy and status messages.
