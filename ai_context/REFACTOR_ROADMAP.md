...
- 已存在少量獨立 module：
  ...
  - `settingsCopy.ts`：Settings navigation, active-profile display copy, voice quota minute formatting, model/quota/reminder/privacy bounded copy.
