...
- 已存在少量獨立 module：
  ...
  - `subscriptionCopy.ts`：Subscription plan/status labels, plan display copy, membership trial-days display copy, account security, profile boundary, and settings subscription section labels / bounded copy.
