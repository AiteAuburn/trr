...
- 已存在少量獨立 module：
  ...
  - `settingsCopy.ts`：Settings navigation, active-profile display copy, voice quota minute formatting/warning copy, model/quota/reminder/privacy bounded copy.
