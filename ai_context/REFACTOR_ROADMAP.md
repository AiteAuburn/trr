...
- 已存在少量獨立 module：
  ...
  - `futureModuleDisplay.ts`：future-module static card config, bounded display card, selected-module display shaping, detail/status copy, Community leaderboard display, Community public settings transform, Food Community category/share/item display, Food Community API transform, Food Community share form defaults, Store category / product preview / product display / backend reward transform / redemption display / fulfillment copy, achievement / food-photo / store-cart / year-review future display copy, future-preview boundary display items/copy, and future-preview section labels.
