...
- 已存在少量獨立 module：
  ...
  - `subscriptionCopy.ts`：Subscription plan/status labels and plan display copy, account security, profile boundary, and settings subscription section labels / bounded copy.
