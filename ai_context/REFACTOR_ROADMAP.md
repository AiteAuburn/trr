...
- 已存在少量獨立 module：
  ...
  - `futureModuleDisplay.ts`：future-module static card config, bounded display card, selected-module display shaping, detail/status copy, Store category / fulfillment copy, achievement / food-photo / store-cart / year-review future display copy, future-preview boundary display items/copy, and future-preview section labels.
