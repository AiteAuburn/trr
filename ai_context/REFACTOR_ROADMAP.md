...
- 已存在少量獨立 module：
  ...
  - `settingsCopy.ts`：Settings navigation, active-profile display copy, model/quota/reminder/privacy bounded copy.
