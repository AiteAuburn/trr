...
- 已存在少量獨立 module：
  ...
  - `sharedDisplayItems.ts`：Shared bounded tuple, metric, option, comparison, tutorial, reminder, session-management preview, destination-card, menu, visual-smoke route, and checklist display item builders.
